...
for i = 1:length(subjects)
    ...
    % results folder
    subject_results_folder = fullfile(results_dir, preprocessed_name, med_name,sprintf('sub-%s', subject));
...
for sub = 4:numel(subjects)
    ...
    % Load subject data
    subject_data = fullfile(data_dir, rawdata_name, [subject, '_', med_name, '_Rest.mat']); % Windows
    ...
    %save(save_metadata, 'participant_metadata');
        ...
        if show_plots
            ...
            % Save Graphics
            gr1 = fullfile(subject_results_folder, [subject, '_', med_name, '_PeakDetectionCheck.png']);
        ...
        if ismember('Preprocessing ECG', steps)
            ...
            if show_plots
                ...
                % Save Graphics
                gr2 = fullfile(subject_results_folder, [subject, '_', med_name, '_ECG-DCOffset-vs-Notch.png']);
            ...
            if show_plots
                ...
                % Save Graphics
                gr3 = fullfile(subject_results_folder, [subject, '_', med_name, '_ECG-Filter(0-30Hz).png']);
        ...
        if ismember('Preprocessing EEG', steps)
            ...
            if show_plots
                ...
                % Save Graphics
                gr5 = fullfile(subject_results_folder, [subject, '_', med_name, '_EEG_HP-LP-Filter.png']);
        ...
        save_path = fullfile(subject_preprocessed_folder, [subject,  '_preprocessed_', med_name ,'_Rest.mat']);
